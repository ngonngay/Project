...
public class OrderService {
    ...
    public static String printOrder2(Order order) {
        ...
        for (Product product : order.getProductList()) {
            str1 = str1 + String.format("\n%5s",product.getName());
            str1 = str1 + String.format("\n%6s",product.getProductId());
            str1 = str1 + String.format("%23s %10d %21s", printPrice(product.getPrice()), product.getAmount(), printPrice(Total(product)));
            if (product.getDiscounted() >= 1) {
                    str1 = str1 + String.format("\nKhuyến mãi: %56s", printPrice(product.getDiscounted()));
                    str1 = str1 + '\n';
            }
            else{
                    str1 = str1 + "\n";
        ...
        str1 = str1 + "\n--------------------------------------------------------------";
        str1 = str1 + String.format("\nTổng thanh toán: %35s", printPrice(totalOrder(order)));
        str1 = str1 + "VNĐ";
        str1 = str1 + "\n--------------------------------------------------------------";
